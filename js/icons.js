...
wand: wrap('<path d="m15 4 1 2 2 1-2 1-1 2-1-2-2-1 2-1z"/><path d="M9 9 4 20l11-11z"/><path d="M18 14v2M20 15h-2"/>'),
...
layers: wrap('<path d="m12 2 9 5-9 5-9-5z"/><path d="m3 12 9 5 9-5"/><path d="m3 17 9 5 9-5"/>'),
megaphone: wrap('<path d="M3 11v2a1 1 0 0 0 1 1h2l9 5V5L6 10H4a1 1 0 0 0-1 1z"/><path d="M18 8a4 4 0 0 1 0 8"/>'),
lightbulb: wrap('<path d="M9 18h6M10 21h4"/><path d="M8 14a5 5 0 1 1 8 0c-.7.9-1.5 1.6-1.5 2.5V17h-5v-.5c0-.9-.8-1.6-1.5-2.5z"/>'),
store: wrap('<path d="M3 9 4.5 4h15L21 9"/><path d="M4 9v10a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V9"/><path d="M3 9a2.5 2.5 0 0 0 5 0 2.5 2.5 0 0 0 5 0 2.5 2.5 0 0 0 5 0 2.5 2.5 0 0 0 3 0"/><path d="M9 20v-6h6v6"/>'),
...
thumbsUp: wrap('<path d="M7 10v11H4a1 1 0 0 1-1-1v-9a1 1 0 0 1 1-1z"/><path d="M7 10 12 3a2 2 0 0 1 3 2l-1 5h5a2 2 0 0 1 2 2.3l-1.2 7A2 2 0 0 1 17 21H7z"/>'),
grid: wrap('<rect x="3" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="14" width="7" height="7" rx="1.5"/><rect x="3" y="14" width="7" height="7" rx="1.5"/>'),
zap: wrap('<path d="M13 2 4 14h7l-1 8 9-12h-7z"/>'),
phone: wrap('<path d="M4 4h4l2 5-2.5 1.5a11 11 0 0 0 5 5L15 12l5 2v4a2 2 0 0 1-2.2 2A16 16 0 0 1 4 6.2 2 2 0 0 1 6 4z"/>'),
globe: wrap('<circle cx="12" cy="12" r="9"/><path d="M3 12h18"/><path d="M12 3a15 15 0 0 1 0 18 15 15 0 0 1 0-18z"/>'),
instagram: wrap('<rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><path d="M17.5 6.5h.01"/>'),
facebook: wrap('<path d="M15 3h-2.5A3.5 3.5 0 0 0 9 6.5V9H6.5v3H9v9h3v-9h2.5l.5-3H12V6.8c0-.6.3-.8.9-.8H15z"/>'),
google: wrap('<path d="M21 12.2c0 5-3.4 8.5-8.5 8.5a8.7 8.7 0 1 1 5.8-15.2l-2.4 2.3A5.3 5.3 0 1 0 17.8 11H12v-2.9h8.8c.1.7.2 1.4.2 2.1z"/>'),
};
